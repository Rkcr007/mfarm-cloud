...
| [0016](adrs/0016-virtual-devices-present-as-named-handsets.md) | Two virtual devices are configured to **be a Galaxy S25 / S25 Ultra** — panel, density, RAM and reported identity — and are drawn as one | Matching the geometry but keeping `model` honest. Cheaper and fully ADR-0003-compliant; the demo impact of the real name was judged to outweigh it, given the VIRTUAL tag and the ABI preflight. |
