...
apps/api/          Fastify + Postgres. Allocation, leases, fencing, runs, artifacts,
                   the WebDriver hub, RLS tenancy, metrics. 56 migrations.
...
docs/adrs/         39 decisions, each with what was rejected and why (numbered to 0041;
                   there is no 0013).
```
...
2. `docs/adrs/` — 39 decisions (numbered to 0041; there is no 0013). Each says what was rejected
