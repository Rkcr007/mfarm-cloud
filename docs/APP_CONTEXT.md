...
docs/adrs/         35 decisions, each with what was rejected and why (numbered to 0036;
                   there is no 0013).
```
...
2. `docs/adrs/` — 35 decisions (numbered to 0036; there is no 0013). Each says what was rejected
